...
# Load database
json_file = '/home/v172/PROJECT/xview_recognition/xview_ann_train.json'
...
for json_img, json_ann in zip(json_data['images'], json_data['annotations']):
    image = GenericImage('/home/v172/PROJECT/xview_recognition/' + json_img['file_name'])
...
n_neurons_per_hidden_layer = [1000, 500, 25]

model = Sequential()
model.add(Flatten(input_shape=(224, 224, 3)))
for neurons in n_neurons_per_hidden_layer:
  model.add(Dense(neurons, activation="elu", kernel_initializer = "he_normal", 
...
optimizer = Adagrad(lr=1e-3, epsilon=1e-08, decay=0.0001)
model.compile(loss='categorical_crossentropy', optimizer=optimizer, metrics=['accuracy'])

"""
# Learning rate is changed to 0.001
opt = Adam(lr=1e-3, beta_1=0.9, beta_2=0.999, epsilon=1e-8, decay=0.0001, amsgrad=True, clipnorm=1.0, clipvalue=0.5)
...
# Load database
json_file = '/home/v172/PROJECT/xview_recognition/xview_ann_test.json'
with open(json_file) as ifs:
    json_data = json.load(ifs)
ifs.close()
